...
#define	ObjectName			"TileBox"
#define	ObjectAuthor		"RickyRombo"
#define	ObjectCopyright		"Copyright © 2010 RickyRombo"
#define	ObjectComment		"Lets you make fancy boxes more simply"
#define	ObjectURL			"http://rickyrombo.co.nr"
#define	ObjectHelp			"N/A"
...
#define	IDENTIFIER			MAKEID(B,T,L,E)
